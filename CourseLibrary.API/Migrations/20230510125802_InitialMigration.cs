    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("102b566b-ba1f-404c-b2df-e2cde39ade09"), 1264248815616001868L, "Arnold", "The Unseen Stafford", "Singing" });

            migrationBuilder.InsertData(
                table: "Authors",
                columns: new[] { "Id", "DateOfBirth", "FirstName", "LastName", "MainCategory" },
                values: new object[] { new Guid("2902b665-1190-4c70-9915-b9c2d7680450"), 1264753115136001928L, "Eli", "Ivory Bones Sweet", "Singing" });

            migrationBuilder.InsertData(
                table: "Authors",
                columns: new[] { "Id", "DateOfBirth", "FirstName", "LastName", "MainCategory" },
                values: new object[] { new Guid("2aadd2df-7caf-45ab-9355-7f6332985a87"), 1279813091328001868L, "Rutherford", "Fearless Cloven", "General debauchery" });

            migrationBuilder.InsertData(
                table: "Authors",
                columns: new[] { "Id", "DateOfBirth", "FirstName", "LastName", "MainCategory" },
                values: new object[] { new Guid("2ee49fe3-edf2-4f91-8409-3eb25ce6ca51"), 1280793378816001868L, "Atherton", "Crow Ridley", "Rum" });

            migrationBuilder.InsertData(
                table: "Authors",
                columns: new[] { "Id", "DateOfBirth", "FirstName", "LastName", "MainCategory" },
                values: new object[] { new Guid("5b3621c0-7b12-4e80-9c8b-3398cba7ee05"), 1264066560000001928L, "Seabury", "Toxic Reyson", "Maps" });

            migrationBuilder.InsertData(
                table: "Authors",
                columns: new[] { "Id", "DateOfBirth", "FirstName", "LastName", "MainCategory" },
                values: new object[] { new Guid("d28888e9-2ba9-473a-a40f-e38cb54f9b35"), 1279360106496001868L, "Berry", "Griffin Beak Eldritch", "Ships" });

            migrationBuilder.InsertData(
                table: "Authors",
                columns: new[] { "Id", "DateOfBirth", "FirstName", "LastName", "MainCategory" },
                values: new object[] { new Guid("da2fd609-d754-4feb-8acd-c4f9ff13ba96"), 1277955145728001868L, "Nancy", "Swashbuckler Rye", "Rum" });
